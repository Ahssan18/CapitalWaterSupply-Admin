...
class SpongyCastleKeystoreHelper {
     ...
     */
    public void storeKey(final byte[] key, final String alias, final SampleAppKeys.EnumKeyType keyType)
    ...
    private void storeToKeystoreFile(final byte[] key, final String alias,
                                     final SampleAppKeys.EnumKeyType keyType, final String algorithmType) {

        if (keyType
                == SampleAppKeys.EnumKeyType.EnumMifareKey)  //Bouncy castle does not support custom MIFARE keys.
        {
